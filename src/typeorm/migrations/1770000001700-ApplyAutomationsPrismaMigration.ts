...
export class ApplyAutomationsPrismaMigration1770000001700 implements MigrationInterface {
  name = 'ApplyAutomationsPrismaMigration1770000001700';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await this.applyPrismaSqlMigration(queryRunner, '20260225170000_add_automations');
  }
