...
export class ApplyStripeBillingPrismaMigration1770000002700 implements MigrationInterface {
  name = 'ApplyStripeBillingPrismaMigration1770000002700';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await this.applyPrismaSqlMigration(queryRunner, '20260309123000_add_stripe_billing_flow');
  }
